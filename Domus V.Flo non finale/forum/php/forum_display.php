...
//On récupère la valeur du forum
$forum = (int) $_GET['f'];
...
Ub.uidUsers AS membre_pseudo_createur, post_createur, post_time, Ua.uidUsers AS membre_pseudo_last_posteur, post_id FROM forum_topic 
LEFT JOIN users Ub ON Ub.idUsers = forum_topic.topic_createur
LEFT JOIN forum_post ON forum_topic.topic_last_post = forum_post.post_id
LEFT JOIN users Ua ON Ua.idUsers = forum_post.post_createur    
...
$query=$db->prepare('SELECT forum_topic.topic_id, topic_titre, topic_createur, topic_vu, topic_post, topic_time, topic_last_post,
Ua.uidUsers AS membre_pseudo_createur, post_id, post_createur, post_time, Ua.uidUsers AS membre_pseudo_last_posteur FROM forum_topic
LEFT JOIN users Ub ON Ub.idUsers = forum_topic.topic_createur
LEFT JOIN forum_post ON forum_topic.topic_last_post = forum_post.post_id
LEFT JOIN users Ua ON Ua.idUsers = forum_post.post_createur   
WHERE topic_genre <> "Annonce" AND forum_topic.forum_id = :forum
